...
grant select, insert, update on public.typology_sessions to authenticated;
grant select, insert, update on public.typology_answers to authenticated;
grant select, insert, update on public.typology_results to authenticated;
